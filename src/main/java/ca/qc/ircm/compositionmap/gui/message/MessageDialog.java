...
package ca.qc.ircm.compositionmap.gui.message;

import ca.qc.ircm.compositionmap.gui.JavafxUtils;
...
public class MessageDialog {
  ...
  private Image getIcon(MessageDialogType type) {
    ...
    switch (type) {
      case ERROR:
        image = new Image(getResourcePath("minus-32.png"));
        break;
      case WARNING:
        image = new Image(getResourcePath("warning-32.png"));
        break;
      case INFORMATION:
        image = new Image(getResourcePath("info-32.png"));
        break;
      case QUESTION:
        image = new Image(getResourcePath("question-32.png"));
        break;
      default:
        image = new Image(getResourcePath("info-32.png"));
        break;
